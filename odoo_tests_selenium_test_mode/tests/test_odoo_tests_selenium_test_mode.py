...
from odoo.addons.odoo_tests_selenium_test_mode.tests.odoo_tests import OdooTestsHttpCase

_logger = logging.getLogger(__name__)


class TestOdooTestsSeleniumTestModeTransactionCase(OdooTestsHttpCase):
