...
from openerp.addons.odoo_tests_selenium_test_mode.tests.test_odoo_tests_selenium_test_mode import (
    TestOdooTestsSeleniumTestModeTransactionCase,
)
    ...
    def enter_test_mode(self):
        ...
        if param == "False":
            ...
            unittest2.TextTestRunner(
                verbosity=2, stream=TestStream("odoo_tests_selenium_test_mode")
            ).run(suite)
