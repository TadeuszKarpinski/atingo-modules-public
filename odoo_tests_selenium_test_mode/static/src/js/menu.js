...
function OdooTestsSeleniumTestModeMenu({ env }) {
    // console.log(this);
    // console.log(env);
    // console.log(env.services);
    // console.log(env.orm);
    // console.log(env.orm.rpc);
    // env.services.rpc("ir.config_parameter", "get_odoo_tests_selenium_test_mode", [])
    // env["ir.config_parameter"].get_odoo_tests_selenium_test_mode()
    ...
    const param_value = await this.async(() => env.services.orm.call(
        'ir.config_parameter',
        'get_odoo_tests_selenium_test_mode',
        [],
    ));
    alert(param_value);
    // var param_value = env.services.orm.call('ir.config_parameter', 'get_odoo_tests_selenium_test_mode', []);
...
//     //     alert("a");
//     // });
//     var param_value = env.services.orm.call('ir.config_parameter', 'get_odoo_tests_selenium_test_mode', []).then(function (param_value) {
...
registry
    .category("debug")
    .category("default")
    .add("OdooTestsSeleniumTestModeMenu", OdooTestsSeleniumTestModeMenu)
