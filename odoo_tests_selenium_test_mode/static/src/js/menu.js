...
openerp.odoo_tests_selenium_test_mode = function (instance) {

    instance.web.ViewManagerAction.include({

        start: function() {
            var self = this;
            new instance.web.Model('ir.config_parameter').call('get_odoo_tests_selenium_test_mode').then(function (param_value) {
                self.odoo_tests_selenium_test_mode = (param_value.toLowerCase() === 'true');
                console.log(self.odoo_tests_selenium_test_mode);
            });
        ...
        enter_test_mode: function () {
            new instance.web.Model('ir.config_parameter').call('get_odoo_tests_selenium_test_mode').then(function (param_value) {
                if (param_value.toLowerCase() !== 'false') {
                    ...
                    instance.session.rpc("/odoo_tests_mode_notification", { "channel": "odoo_tests_selenium_test_mode", "message": "enter_test_mode" }).then(function () {
                        setTimeout(function () {
        ...
        leave_test_mode: function () {
            new instance.web.Model('ir.config_parameter').call('get_odoo_tests_selenium_test_mode').then(function (param_value) {
                ...
                if (param_value.toLowerCase() !== 'true') {
                    ...
                    setTimeout(function () {
                        instance.session.rpc("/odoo_tests_mode_notification", { "channel": "odoo_tests_selenium_test_mode", "message": "leave_test_mode" }).then(function () {
                            location.reload();
                        });
                    }, 3000);
                }
